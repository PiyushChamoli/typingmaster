...
function App() {
  ...
  return (
    <>
      <nav className="flex w-full justify-center items-center p-6 text-white">
        <h1 className="text-4xl font-bold text-gray-800 tracking-wide hover:text-blue-600 transition-colors duration-300">
          Typing Master
        </h1>
      </nav>
